...
my_mic = sr.Microphone(device_index=device_index) #my device index is 1, you have to put your device index

def listen_mic(audio):
	r = sr.Recognizer()
...
def gen_html():
	return "<span id=\"file-contents\"></span>" + su.add_script("refresh_script.js")
...
if __name__ == '__main__':
	...
	with Manager() as manager:
		...
		while True:
			audio1["Text"] = ""
			audio2["Text"] = ""
			p_listen1 = Process(target=listen_mic, args=(audio1,))
			p_process1 = Process(target=process_audio, args=(audio1,))
			p_listen2 = Process(target=listen_mic, args=(audio2,))
